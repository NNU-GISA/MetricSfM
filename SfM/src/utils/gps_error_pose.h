...
#ifndef OBJECTSFM_OPTIMIZER_GPS_ERROR_POSE_H_
#define OBJECTSFM_OPTIMIZER_GPS_ERROR_POSE_H_
...
namespace objectsfm
{
	...
	struct GPSErrorPose
	{
		GPSErrorPose(const double angle1, const double angle2, const double angle3, const double weight)
		...
		{
			return (new ceres::AutoDiffCostFunction<GPSErrorPose, 3, 6, 6, 6>(
				new GPSErrorPose(angle1, angle2, angle3, weight)));
		}
